...
<body id="page-top">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col auto">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Jumlah Customer Year 2013</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(CustomerID)) as customer FROM fact_sales fs JOIN dimensi_date dd ON fs.dateID = dd.dateID WHERE dd.Year=2013";
                                                $query = mysqli_query($mysqli, $sql);
                                                while ($row2 = mysqli_fetch_array($query)) {
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col auto">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Rata-rata revenue</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT AVG(revenue) as avg FROM fact_sales";
                                                $query = mysqli_query($mysqli, $sql);
                                                while ($row2 = mysqli_fetch_array($query)) {
    ...
    <script type="text/javascript">
        ...
        $year = "SELECT DISTINCT(t.Year) as year FROM fact_sales fs JOIN dimensi_date t on t.DateID = fs.DateID";
        $customer = "SELECT COUNT(DISTINCT(fs.CustomerID)) as customer FROM fact_sales fs JOIN dimensi_date t on t.DateID = fs.DateID GROUP BY t.Year";
        $i = 1;
    ...
    <script type="text/javascript">
        ...
        $database = "whadventure2019";
        $conn = mysqli_connect($host, $user, $password, $database);
        $bulan = "SELECT MONTHNAME(t.FullDate) bulan FROM fact_sales sf JOIN dimensi_date t ON sf.DateID = t.DateID GROUP BY t.Month ORDER BY t.DateID";
        $amount1 = "SELECT COUNT(DISTINCT(sf.CustomerID)) as customer FROM fact_sales sf JOIN dimensi_date t on t.DateID = sf.DateID WHERE t.Year = 2013 GROUP BY t.Month ORDER BY t.DateID";
        $amount2 = "SELECT COUNT(DISTINCT(sf.CustomerID)) as customer FROM fact_sales sf JOIN dimensi_date t on t.DateID = sf.DateID WHERE t.Year = 2014 GROUP BY t.Month ORDER BY t.DateID";
