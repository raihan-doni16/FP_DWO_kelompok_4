...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">Store</h1>
                    </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col auto">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Jumlah Store Aktif dalam Pembelian</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(storeID)) aktif FROM fact_sales";
                                                $query = mysqli_query($mysqli, $sql);
                                                while ($row2 = mysqli_fetch_array($query)) {
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Trend Peningkatan Store Setiap Year</h6>
                                </div>
                                <div class="card-body">
    ...
    <script type="text/javascript">
        ...
        $store = "SELECT COUNT(DISTINCT(sf.storeID)) as store FROM fact_sales sf JOIN dimensi_date t on t.dateID = sf.dateID GROUP BY t.DateID";
        $i = 1;
        ...
        $jumlah_store = mysqli_num_rows($query_store);
        $chart_store = "";
        while ($row1 = mysqli_fetch_array($query_store)) {
            if ($a < $jumlah_store) {
                $chart_store .= $row1['store'];
                $chart_store .= ',';
                $a++;
            } else {
                $chart_store .= $row1['store'];
